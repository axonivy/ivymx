 ...
 * The parsed String values can contain EL scripts enclosed in #{...}. The EL scripts can contain attributes of the {@link MBean}. The attributes can be provided as fields or getter/setter methods. It is also possible to access attributes of attributes.<br>
 * Example:
 * <pre>
 * {@code @MBean}
 * public class MyBean
